      ...
      <div class="flex flex-col">
        <header class="sticky top-0 z-[9] transition-transform bg-firi-blue">
          <div class="flex justify-center">
            <div
              class="w-full px-4 lg:px-9 max-w-[1440px] flex items-center py-4"
            >
              <div class="flex flex-1 items-center space-x-14">
                <a
                  class="flex h-[24px] w-[80px] md:h-[36px] md:w-[132px]"
                  aria-label="<?php echo getLang('menu_home'); ?>"
                  href="<?php echo getHref('') ?>"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="127.422 140.716 41.143 24"
                    style="height: 100%"
                  >
                    <path
              ...
              <div class="hidden lg:flex">
                <a
                  ...
                  ><button
                    ...
                    type="button"
                    aria-label="<?php echo getLang('menu_login'); ?>"
                  >
              ...
              <div class="lg:hidden">
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    aria-hidden="true"
                    class="inline-block w-[20px] h-[20px] text-white fill-white"
                  >
                    <path
        ...
        <div
          data-menu
          class="bg-firi-blue fixed bottom-0 left-0 right-0 top-0 z-50 h-screen w-screen"
        >
          <div class="fixed top-0 h-full overflow-y-auto pb-24 w-full">
            <div
              class="flex items-center justify-between border-b border-white p-4"
            >
              <div>
                <a
                  class="flex h-[24px] w-[80px] md:h-[36px] md:w-[132px]"
              ...
              >
                <span>
                  <svg
                    ...
                    fill="#12123B"
                    aria-hidden="true"
                    class="inline-block w-[24px] h-[24px] fill-white text-white"
                  >
                    <path
                      d="M4.28038 3.21999L3.21973 4.28064L19.7197 20.7806L20.7804 19.72L4.28038 3.21999Z"
                    ></path>
                    <path
                      d="M19.7197 3.21936L3.21973 19.7194L4.28038 20.78L20.7804 4.28001L19.7197 3.21936Z"
                    ></path>
                  </svg>
                </span>
              </button>
              ...
              <div class="mb-6 border-b border-white pb-6">
                <div>
                  <a href="<?php echo getHref('') ?>">
                    <span
                      class="rs-landing-lg text-white break-words mb-4 block"
                  ...
                  <a href="<?php echo getHref('about') ?>">
                    <span
                      class="rs-landing-lg text-white break-words mb-4 block"
                      ><?php echo getLang('menu_about'); ?></span
                    >
                  </a>
                  <a href="<?php echo getHref('login') ?>">
                    <span
                      class="rs-landing-lg text-white break-words mb-4 block"
                      ><?php echo getLang('menu_contact'); ?></span
                    >
                  </a>
                </div>
              </div>
        ...
        <div class="lg:bg-firi-light-grey bg-white">
          <section
            class="border-firi-blue mb-4 border-b py-4 md:mb-10 md:py-10"
          >
            <div class="flex justify-center">
              <div class="w-full px-4 lg:px-9 max-w-[1440px]">
                <div class="overflow-hidden flex justify-between">
                  <div
                    class="col-span-12 md:col-span-6 flex flex-col justify-center max-w-full"
                  >
                    <h1
                      class="rs-landing-3xl text-text-light-blue dark:text-text-dark-blue break-words pb-[2px]"
                    >
          ...
          <div class="flex justify-center">
            <div class="w-full max-w-[1440px] px-0 py-4 md:py-12 lg:px-4">
              <div
                class="grid grid-cols-2 gap-4 md:grid-cols-6 lg:grid-cols-12 lg:gap-10"
              >
                <div
                  class="col-span-full hidden space-y-10 self-start lg:col-span-3 lg:block"
                >
                  <nav aria-label="Table of contents">
                    <div
                      class="rounded-xl p-4 border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white lg:p-10"
                    >
                      <div>
                        <div class="flex items-center justify-between">
                          <h3
                            class="rs-landing-lg text-text-light-blue dark:text-text-dark-blue break-words"
                          >
                        ...
                        <ul class="mt-6 space-y-6">
                          <li>
                            <a
                              href="#1-introduction"
                              class="flex cursor-pointer align-baseline transition duration-300 ease-in-out text-black-700"
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__introduction_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              href="#2-data-controller"
                              class="flex cursor-pointer align-baseline transition duration-300 ease-in-out text-black-700"
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__data_controller_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              href="#3-what-personal-information-we-collect-and-reason-for-processing"
                              class="flex cursor-pointer align-baseline transition duration-300 ease-in-out text-black-700"
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__collect_reason_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              href="#4-disclosure-of-personal-information-to-third-parties"
                              class="flex cursor-pointer align-baseline transition duration-300 ease-in-out text-black-700"
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__disclosure_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              ...
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__security_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              ...
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__storage_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              ...
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__rights_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              href="#8-links-to-third-parties"
                              class="flex cursor-pointer align-baseline transition duration-300 ease-in-out text-black-700"
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__third_parties_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              ...
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__complaints_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              ...
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('privacy__cookies_title'); ?></span
                              ></a
                            >
                          </li>
                        </ul>
                ...
                <div class="col-span-full lg:col-span-9">
                  <div class="cms">
                    <section
                      id="1-introduction"
                      style="scroll-margin-block: 100px"
                      data-sanity-key="1-introduction"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
                        <div>
                          <div>
                            <h2
                              class="rs-landing-xl text-text-light-blue dark:text-text-dark-blue break-words pb-[2px]"
                            >
                              <?php echo getLang('privacy__introduction_title'); ?>
                            </h2>
                          </div>
                          <div
                            class="overflow-hidden transition-all max-h-[10000px] pt-4"
                          >
                            <div class="cms">
                              <section
                              ...
                              >
                                <p
                                  class="rs-landing-md text-text-light-1 dark:text-white break-words"
                                >
                    ...
                    <section
                      ...
                      style="scroll-margin-block: 100px"
                      data-sanity-key="2-data-controller"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
                    ...
                    <section
                      id="3-what-personal-information-we-collect-and-reason-for-processing"
                      style="scroll-margin-block: 100px"
                          ...
                          >
                            <div class="cms">
                              ...
                              >
                                ...
                                >
                                  <strong
                                    ><?php echo getLang('privacy__collect_reason_creation_title'); ?></strong
                                  >
                              ...
                              >
                                ...
                                >
                                  <strong
                                    ><?php echo getLang('privacy__collect_reason_user_data_title'); ?></strong
                                  >
                              ...
                              >
                                ...
                                >
                                  <strong
                                    ><?php echo getLang('privacy__collect_reason_marketing_title'); ?></strong
                                  >
                    ...
                    <section
                      id="4-disclosure-of-personal-information-to-third-parties"
                      style="scroll-margin-block: 100px"
                      data-sanity-key="4-disclosure-of-personal-information-to-third-parties"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
                    ...
                    <section
                      id="5-data-security"
                      style="scroll-margin-block: 100px"
                      data-sanity-key="5-data-security"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
                    ...
                    <section
                      id="6-data-storage"
                      style="scroll-margin-block: 100px"
                      data-sanity-key="6-data-storage"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
                    ...
                    <section
                      id="8-links-to-third-parties"
                      style="scroll-margin-block: 100px"
                      data-sanity-key="8-links-to-third-parties"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
        ...
        <footer class="bg-firi-blue pb-24 pt-10 md:py-10">
            ...
            <div class="w-full px-4 lg:px-9 max-w-[1440px]">
              <div class="grid gap-4 md:grid-cols-6 lg:grid-cols-12 lg:gap-10">
                <div class="col-span-full">
                  <div
                    class="block lg:col-span-2 h-[24px] w-[80px] md:h-[36px] md:w-[132px]"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="127.422 140.716 41.143 24"
                ...
                <div class="col-span-1 md:col-span-full lg:col-span-2">
                  <a
                    class="mb-2 flex items-center text-white hover:underline"
                    href="<?php echo getHref('') ?>"
                  >
                    <span class="rs-landing-sm text-white break-words"
                      ><?php echo getLang('menu_home'); ?></span
                    >
                  </a>
                  <a
                  ...
                  >
                    <span class="rs-landing-sm text-white break-words"
                      ><?php echo getLang('menu_terms'); ?></span
                    >
                  </a>
                </div>
                <div
                  class="col-span-1 flex items-end md:col-span-full md:items-start lg:col-span-2"
                >
                  <div class="lang-select menu-call" data-open="false">
                    <?php generateLanguageSelector() ?>
                  </div>
          ...
          <div
            class="fixed bottom-0 left-0 right-0 items-center justify-center bg-white p-4 flex md:hidden"
          >
            <div class="mr-4">
              <a
