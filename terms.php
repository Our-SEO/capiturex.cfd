              ...
              >
                          ...
                          <li>
                            <a
                              ...
                              ><span
                                ...
                                ><?php echo getLang('terms__general_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              ...
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('terms__accounts_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              href="#3-buying-and-selling"
                              class="flex cursor-pointer align-baseline transition duration-300 ease-in-out text-black-700"
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('terms__buying_selling_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              href="#4-responsibility-and-compensation"
                              class="flex cursor-pointer align-baseline transition duration-300 ease-in-out text-black-700"
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('terms__responsibility_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              ...
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('terms__staking_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              href="#6-governing-law"
                              class="flex cursor-pointer align-baseline transition duration-300 ease-in-out text-black-700"
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('terms__governing_law_title'); ?></span
                              ></a
                            >
                          </li>
                          <li>
                            <a
                              href="#7-change-of-terms"
                              class="flex cursor-pointer align-baseline transition duration-300 ease-in-out text-black-700"
                              ><span
                                class="rs-landing-sm text-text-light-2 dark:text-text-dark-2 break-words hover:text-black-900 hover:font-semibold"
                                ><?php echo getLang('terms__change_terms_title'); ?></span
                              ></a
                            >
                          </li>
                        </ul>
                ...
                <div class="col-span-full lg:col-span-9">
                  <div class="cms">
                        ...
                        <div>
                          ...
                          >
                            <div class="cms">
                              ...
                              >
                                <h3
                                  class="rs-landing-lg text-text-light-1 dark:text-white break-words"
                                >
                    ...
                    <section
                      id="3-buying-and-selling"
                      style="scroll-margin-block: 100px"
                      data-sanity-key="3-buying-and-selling"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
                    ...
                    <section
                      id="4-responsibility-and-compensation"
                      style="scroll-margin-block: 100px"
                      data-sanity-key="4-responsibility-and-compensation"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
                    ...
                    <section
                      id="6-governing-law"
                      style="scroll-margin-block: 100px"
                      data-sanity-key="6-governing-law"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
                    ...
                    <section
                      id="7-change-of-terms"
                      style="scroll-margin-block: 100px"
                      data-sanity-key="7-change-of-terms"
                    >
                      <div
                        class="border-black-150 dark:bg-card-dark-1 dark:border-text-dark-4 bg-white mb-8 overflow-hidden p-6 lg:mb-10 lg:px-20 lg:py-14 rounded-none lg:rounded-xl"
                      >
                        ...
                        >
                          <span
                            ><div class="flex items-center space-x-2">
                              <span
                                ><?php echo getLang('terms__create_account_button'); ?></span
                              >
                            </div></span
                          >
                        </div></a
